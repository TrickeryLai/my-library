        ...
        <div
          ...
          <van-col span="8">
            <div @click="sortAmount">
              ...
              <span class="rant-arrow">
								...
								<i class="iconfont icon-arrowdownb" :class="{'rant-active': (sortState.amountSort === 1)}"
                   name="arrow-down"/>
							</span>
            </div>
          </van-col>
          <van-col span="8">
            <div @click="sortPublish">
              发布时间
              <span class="rant-arrow">
								<i class="iconfont icon-arrowup" :class="{'rant-active': sortState.createTimeSort === 0}"
                   name="arrow-up"/>
