<template>
	<div>
		...
		<div class="checkMoney-page" v-show="nextStepStatus">
			<p class="checkMoney-page-topTitle" style="font-size: 18px;width: 70%;display:inline-block;">您添加的对公结算账户正在审核中，请耐心等待审核结果。审核通过后，可在“银行账户设置”页面看到账户状态为“认证成功”</p>
