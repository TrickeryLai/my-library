			...
			<van-collapse-item class="text-left" name="1" style="height: 100%;position: relative;overflow-y:scroll;">
				...
				<div style="border: 1px solid #ccc;">
					...
					<template slot="title">
						...
						<van-row v-if="item.quoteStatus == '00'">
							<van-col span="24">指定时间：{{item.quoteTime}}</van-col>
						</van-row>
						<van-row v-if="item.quoteStatus == '00'">
							<van-col span="24" style="text-align: center;"><van-tag round type="danger">等待您报价</van-tag></van-col>
						</van-row>
						<van-row v-if="item.quoteStatus != '00'">
							<van-col span="19">
