	...
	<div>
	    ...
	    <div @touchmove.stop class="model-content">
				...
				<van-row class="detail-row">
					...
					<van-col class="detail-row-right" span="18">￥{{dealPrice(detailData.cpCommercialPaperInfo.cpAmount.toFixed(2))}}</van-col>
				</van-row>
				<van-row class="detail-row">
			...
			<van-cell-group>
				...
				<div>
					<img 
					class="ticketPic" 
					:src="detailData.cpCommercialPaperInfo && dealPic(detailData.cpCommercialPaperInfo.frontBillImg)"
					@click="previewPic(0)"
					>
					<img 
					class="ticketPic" 
					:src="detailData.cpCommercialPaperInfo && dealPic(detailData.cpCommercialPaperInfo.backBillImg)"
					@click="previewPic(1)"
					>
				</div>
			</van-cell-group>
	...
	export default {
		...
		methods:{
			...
			getData(){
				...
				_server.cpOrderDetail(this.queryData.ordNo, '11').then(res => {
					if(res.code == 0){
			...
			previewPic(index){
				let imageResult = [_common.picUrl + this.detailData.cpCommercialPaperInfo.frontBillImg, _common.picUrl + this.detailData.cpCommercialPaperInfo.backBillImg];
