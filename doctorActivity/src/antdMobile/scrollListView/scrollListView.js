...
module.exports = React.createClass({
    ...
    componentWillReceiveProps: function(_props) {
        ...
        if (
            ...
            JSON.stringify(this.state.fatch.data) != JSON.stringify(_newState.fatch.data)
        ) {
            this.setState(_newState);
            this.onRefresh();
        }
    ...
    onEndReached: function(event) {
        ...
        _params.pageIndex = this.state.pageIndex;
        ...
        _params.subject = this.props.subject;
        _params.deptId = this.props.deptId;
